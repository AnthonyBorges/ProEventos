...
namespace ProEventos.Application.Dtos
{
    public class EventoDto
    {
        ...
        //  MaxLength(50, ErrorMessage = "{0} deve ter no máximo 50 caracteres!")
         StringLength(50, MinimumLength = 4, ErrorMessage = "Intervalo permitido 4 e 50 caracteres!")
        ]
        public string Tema { get; set; }

        [Display(Name = "Qtd Pessoas"),
         Required(ErrorMessage = "O campo {0} é obrigatório!"),
         Range(1, 120000, ErrorMessage = "{0} não pode ser nenor que 1 e maior que 120.000!")
        ]
        ...
        [Required(ErrorMessage = "O campo {0} é obrigatório!"),
         Phone(ErrorMessage = "O campo {0} precisa ser um número válido!")
        ]
